export const getOrderStatusUpdateTemplate = (
  ...
  if (status === "Confirmed") {
    statusMessage = "Your order has been confirmed by our processing team. We are preparing the items for packaging and labeling.";
    statusColor = "#7c3aed"; // Purple
  } else if (status === "Packed") {
    statusMessage = "Great news! Your package has been carefully prepared and packed at our warehouse. It is waiting for the shipping courier to collect it.";
    statusColor = "#d97706"; // Amber
  } else if (status === "Shipped") {
    statusMessage = "Exciting news! Your package has been handed over to our shipping carrier. It is now on its way to your destination address.";
    statusColor = "#2563eb"; // Blue
  } else if (status === "Delivered") {
    statusMessage = "Success! Your package has been delivered to your address. We hope you enjoy your new LUXE premium products.";
    statusColor = "#16a34a"; // Green
  } else if (status === "Returned") {
    statusMessage = "We have processed the return for this order. A refund has been issued to your account.";
  ...
  return `
    ...
    <head>
      ...
      <title>Order Status Update - ${statusLabel}</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>LUXE</h1>
          <p>Order Status: ${statusLabel}</p>
        </div>
        <div class="content">
          <p class="intro">Dear <strong>${name}</strong>,<br/><br/>${statusMessage}</p>
          ...
          <div class="meta-box">
            ...
            <div class="meta-row">
              ...
              <span class="meta-value" style="color: #ffffff; background-color: ${statusColor}; padding: 2px 8px; border-radius: 4px; font-size: 11px; text-transform: uppercase;">${statusLabel}</span>
            </div>
          </div>
          ...
          <table class="summary-table">
            ...
            <tr class="summary-row" style="font-size: 16px; border-top: 1px solid #cbd5e1;">
              <td style="color: #0f172a; font-weight: 800; padding-top: 12px;">Total Paid:</td>
              <td style="text-align: right; font-weight: 900; color: #0052cc; padding-top: 12px;">৳${order.total.toFixed(2)}</td>
            </tr>
          </table>

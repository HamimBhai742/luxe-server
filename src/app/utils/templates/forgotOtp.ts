export const getForgotOtpTemplate = (name: string, otp: string): string => {
  return `
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <title>Reset Your LUXE Password</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2>Hello ${name},</h2>
          <p>We received a request to reset your password. Use the 6-digit security code below to set a new password.</p>
